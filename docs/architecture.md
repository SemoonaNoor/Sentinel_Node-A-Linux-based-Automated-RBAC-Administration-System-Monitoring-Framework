...
1. **Identity Creation**: The system creates a standard Linux user.
...
graph TD
    ...
    F[Sentinel Dashboard] -->|Reads| G[(sentinel_admin.log)]
    F -->|Polls| H[System Kernel via psutil]
    
    I[Backup Engine] -->|Compresses| J[(srv_dc_storage)]
